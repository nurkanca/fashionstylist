...
public class UserSurveyPreferenceService {
    ...
    @Transactional
    public UserSurveyPreference saveSurvey(SaveSurveyRequest req) {
        if (req == null || req.userId() == null) {
            throw new IllegalArgumentException("userId is required");
        }

        UserSurveyPreference pref = repo.findById(req.userId())
                .orElseGet(() -> new UserSurveyPreference(req.userId()));
